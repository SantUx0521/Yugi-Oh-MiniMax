...
class GameView(ctk.CTkFrame):
    ...
    def update_life_bars(self, user_life, machine_life, max_life=8000):
        ...
        if user_percent > 0.5:
            self.user_life_bar.configure(progress_color="#2ecc71")  
        elif user_percent > 0.25:
            self.user_life_bar.configure(progress_color="#f39c12")  
        else:
            self.user_life_bar.configure(progress_color="#e74c3c")  
        ...
        if machine_percent > 0.5:
            self.machine_life_bar.configure(progress_color="#2ecc71")  
        elif machine_percent > 0.25:
            self.machine_life_bar.configure(progress_color="#f39c12")  
        else:
            self.machine_life_bar.configure(progress_color="#e74c3c")  
